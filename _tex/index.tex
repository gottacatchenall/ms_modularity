...
they have seen some use in ecological networks (Allesina \& Pascual
2009; Gauzens \emph{et al.} 2013; O'Connor \emph{et al.} 2020),
...
Good \emph{et al.} (2010), who also show that \(Q_max\) is highly
dependent on the number of clusters and the size of the network, and
conclude---``{[}the{]} modules identified through modularity
maximization should be treated with caution in all but the most
straightforward cases'' (Good \emph{et al.} 2010).
...
\leavevmode\vadjust pre{\hypertarget{ref-Allesina2009FooWeb}{}}%
